...
import './login.css';
import leaf1 from '../../../public/leaf_01.png';
import leaf2 from '../../../public/leaf_02.png';
import leaf3 from '../../../public/leaf_03.png';
import leaf4 from '../../../public/leaf_04.png';
...
const page = () => {
    ...
    const {user,handleGoogleLogin,login,addUserToDataBase,setLoading} = useAuth();
    ...
    const handleGoogleSignUp = () => {
        ...
        .catch((error) => {
            ...
            Swal.fire({
                ...
                title: "Oops...",
                text: "Something went wrong!",
                footer: '<Link href="/">Go to Home</Link>'
            });
        })
    }
        ...
        <div>
            ...
            <section>
                <div className="leaves">
                    <div className="set">
                        <div><Image src={leaf1} alt="img" /></div>
                        <div><Image src={leaf2} alt="img" /></div>
                        <div><Image src={leaf3} alt="img" /></div>
                        <div><Image src={leaf4} alt="img" /></div> 
                        <div><Image src={leaf1} alt="img" /></div>
                        <div><Image src={leaf2} alt="img" /></div>
                        <div><Image src={leaf3} alt="img" /></div>
                        <div><Image src={leaf4} alt="img" /></div>
                ...
                <Image src={bg} alt='img' className="bg"/>
                <Image src={girl} alt='img' className="girl"/>
